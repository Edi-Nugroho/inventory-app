            ...
            <form action="<?php echo site_url('barangmasuk/simpan'); ?>" method="POST">
                <div class="table-data-input">
                    ...
                    <div class="input-group date mb-4">
                        <label for="input1" class="form-label">Tanggal Masuk</label>
                        <span class="input-group-text" id="basic-addon1">
                            <img src="<?= base_url('assets/icons/'); ?>kalender.png"/ width="25px">
                        </span>
                        <input type="text" class="form-control" id="datepicker" name="tgl_masuk" style="margin-right: 20px;" autocomplete="off" value="<?= date("d-m-Y"); ?>">
                        <span class="input-group-append">
                        </span>
                    </div>

                    <div class="input-group mb-4">
                        <label for="input2" class="form-label">Kuantitas</label>
                        <span class="input-group-text" id="basic-addon1">
                            <img src="<?php echo base_url('assets/icons/')?>box-satuan.png"/ width="25px">
                        </span>
                        <input type="text" id="input2" class="form-control" placeholder="Masukkan Kuantitas" aria-label="Nama" aria-describedby="basic-addon1" name="kuantitas" autocomplete="off">
                    </div>

                    <div class="button-group">
                        <button type="submit" class="btn btn-primary mr-1" style="font-size: 14px;">Submit</button>
                        <a href="<?php echo site_url('barangmasuk')?>" class="btn btn-danger" style="font-size: 14px;">Batal</a>
                    </div>
                </div>
            </form>
